def calculate_score_weights(account_age_years: float, followers: int, tweets: int, is_verified: bool, is_active: bool, engagement: str, positives: int, complaints: int, pinned_has_url: bool) -> dict[str, int]:
    """
